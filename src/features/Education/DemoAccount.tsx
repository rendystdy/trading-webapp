    ...
    <div className="flex flex-col gap-y-6 py-6">
        ...
        <div className="flex h-full flex-col justify-around">
          <div>
            ...
            <ul className="flex flex-col gap-y-4">
              <li className="font-poppins font-normal text-sm text-veryDarkGrey dark:text-white">
      ...
      <div className="flex flex-col gap-y-4 md:flex-row items-start gap-x-4">
        ...
        <div className="flex h-full md:w-1/2 gap-y-4 flex-col justify-around">
          <p className="font-poppins font-normal text-sm text-veryDarkGrey dark:text-white">
          ...
          <div className="px-5 py-6 bg-veryLightGraySecondary rounded-2xl">
            <p className="font-poppins font-bold text-sm text-darkBlueSecondary">
