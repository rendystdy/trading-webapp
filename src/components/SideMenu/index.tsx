      ...
      <SheetContent className={cn("w-full bg-bgHeader/90 dark:bg-veryDarkBlueTertiary/90 md:hidden py-16 px-7", variant === 'DEFAULT' ? "py-16 px-0" : "py-16 pt-4 px-7")}>
        {variant === "PROFILE" && (
          <div className="mb-3">
            ...
            <div className="px-3 py-4 bg-white rounded-2xl w-4/5 dark:bg-veryDarkBlueTertiary">
              ...
              <div className="flex items-center justify-between">
                <Button className="bg-veryLightGrayTertiary dark:bg-veryDarkBlue rounded-full font-poppins font-bold text-base text-center text-black dark:text-lightCyan" title="Change Account" />
                <div className="bg-veryLightGrayTertiary dark:bg-veryDarkBlue rounded-full p-2">
                  <RotateCw className="dark:text-lightCyan" />
                </div>
              </div>
            </div>
          </div>
        ...
        <Accordion type="single" collapsible>
          <ul className={cn(variant === "DEFAULT" ? "mt-11" : "mt-0")}>
                          ...
                          {item.subMenu.map((sub, indexSubmenu) => {
                            return (
                              <li
                                ...
                                className="font-poppins font-normal text-xs mb-3 dark:text-grayishCyan hover:text-hover dark:hover:text-lightCyan cursor-pointer"
                              >
                        ...
                        <ul className="bg-white dark:bg-mainBlue py-3 px-2">
                          {item.subMenu.map((sub, indexSubmenu) => {
                            return (
                              <li
                                key={indexSubmenu.toString()}
                                className="font-poppins font-normal text-xs mb-3 hover:text-hover cursor-pointer dark:hover:text-lightCyan dark:text-grayishCyan"
                              >
                                <Link to={sub.href}>{sub.title}</Link>
                              </li>
                            );
