  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        veryDarkBlue: "#002E5B",
        veryDarkBlueSecondary: "#17236A",
        veryDarkBlueTertiary: "#011c39",
        gray: "#AAAAAA",
        darkGrey: "#7D7D7D",
        darkGreySecondary: "#9A9A9A",
        darkGreyTertiary: "#7A7A7A",
        ...
        veryDarkGreyTertiary: "#5B5B5B",
        veryDarkGreyMostlyBlack: "#1E1E1E",
      ...
      backgroundImage: {
        ...
        "banner-pattern-dark": "url('assets/img/bannerbg_dark.png')",
